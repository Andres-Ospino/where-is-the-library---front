          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            ...
            <div className="bg-white rounded-lg shadow-md p-6 hover:shadow-lg transition-shadow">
              <div className="text-center">
                ...
                <h2 className="text-xl font-semibold text-gray-900 mb-2">Libros</h2>
                <p className="text-gray-600 mb-4">Gestiona el catálogo de libros</p>
                <div className="space-y-2">
                  <Link
                    href="/books"
                  ...
                  <Link
                    href="/books/new"
                    className="block w-full bg-blue-100 text-blue-700 py-2 px-4 rounded-md hover:bg-blue-200 transition-colors"
                  >
                    Agregar Libro
                  </Link>
                </div>
            ...
            <div className="bg-white rounded-lg shadow-md p-6 hover:shadow-lg transition-shadow">
              <div className="text-center">
                ...
                <h2 className="text-xl font-semibold text-gray-900 mb-2">Miembros</h2>
                <p className="text-gray-600 mb-4">Administra los miembros</p>
                <div className="space-y-2">
                  <Link
                    href="/members"
                  ...
                  <Link
                    href="/members/new"
                    className="block w-full bg-green-100 text-green-700 py-2 px-4 rounded-md hover:bg-green-200 transition-colors"
                  >
                    Agregar Miembro
                  </Link>
                </div>
            ...
            <div className="bg-white rounded-lg shadow-md p-6 hover:shadow-lg transition-shadow">
              <div className="text-center">
                ...
                <h2 className="text-xl font-semibold text-gray-900 mb-2">Préstamos</h2>
                <p className="text-gray-600 mb-4">Gestiona préstamos y devoluciones</p>
                <div className="space-y-2">
                  <Link
                    href="/loans"
                    className="block w-full bg-purple-600 text-white py-2 px-4 rounded-md hover:bg-purple-700 transition-colors"
